  ...
  .group(() => {
    ...
    router
      .group(() => {
        ...
        router.put('/settings/password', [PartnerController, 'updatePassword'])
        router.put('/settings/notifications', [PartnerController, 'updateNotifications'])
        router.put('/settings/store', [PartnerController, 'updateStore'])
      })
      .prefix('/partner')
      .use(middleware.jwtAuth())

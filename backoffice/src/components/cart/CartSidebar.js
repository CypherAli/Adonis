...
const CartSidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      {/* Backdrop */}
      {isOpen && <div className="cart-sidebar-backdrop" onClick={handleBackdropClick} />}
                ...
                <div className="item-details">
                  ...
                  <div className="item-quantity">
                    <button
                      className="qty-btn"
                      onClick={() =>
                        handleQuantityChange(item._id, item.variantSku, item.quantity - 1)
                      }

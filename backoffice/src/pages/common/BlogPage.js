  ...
  const blogPosts = [
    {
      ...
      excerpt:
        'Điểm danh những mẫu sneaker được săn đón nhiều nhất năm nay với thiết kế độc đáo và chất lượng vượt trội...',
    ...
    },
    {
      ...
      excerpt:
        'Những tiêu chí quan trọng khi lựa chọn giày chạy bộ: đế giày, chất liệu, độ êm ái... để bảo vệ đôi chân của bạn...',
    ...
    },
    {
      ...
      excerpt:
        'Phân tích chi tiết sự khác biệt giữa hai dòng giày iconic nhất, giúp bạn đưa ra quyết định đúng đắn...',
    ...
    },
    {
      ...
      excerpt:
        'Cách vệ sinh và bảo quản giày đúng cách để đôi giày luôn sạch đẹp và bền lâu như mới...',
    ...
    },
    {
      ...
      excerpt:
        'Khám phá những xu hướng giày mới nhất với công nghệ thân thiện môi trường và vật liệu tái chế...',

    ...
    <div className="about-page">
      ...
      <div className="about-hero">
        <div className="about-hero-content">
          ...
          <p className="about-subtitle">Hệ Thống Bán Lẻ Giày Sneaker Uy Tín Hàng Đầu Việt Nam</p>
        </div>
      </div>
      ...
      <div className="company-story">
        <div className="story-container">
          <div className="story-content">
            ...
            <p>
              <strong>Shoe Store</strong> được thành lập từ năm 2020 với sứ mệnh mang đến cho khách
              hàng Việt những đôi giày sneaker chính hãng, chất lượng cao với giá cả hợp lý nhất.
            </p>
            <p>
              Qua hơn 5 năm phát triển, chúng tôi đã trở thành một trong những đơn vị phân phối giày
              sneaker hàng đầu Việt Nam với hơn <strong>20 cửa hàng</strong> trên toàn quốc và hơn{' '}
              <strong>200,000 khách hàng tin tưởng</strong>.
            </p>
          </div>
      ...
      <div className="mission-vision">
        <div className="mv-container">
          <div className="mv-item mission">
            <h3>Sứ Mệnh</h3>
            <p>
              Cung cấp giày sneaker chất lượng cao và dịch vụ tận tâm, giúp khách hàng thể hiện
              phong cách và nâng cao chất lượng cuộc sống.
            </p>
          </div>
          <div className="mv-item vision">
            <h3>Tầm Nhìn</h3>
            <p>
              Trở thành hệ thống bán lẻ giày sneaker số 1 Việt Nam, được tin yêu và lựa chọn để mua
              sắm giày chính hãng.
            </p>
          </div>
          <div className="mv-item values">
            ...
            <p>
              Chính trực - Chuyên nghiệp - Chất lượng - Cam kết. Luôn đặt lợi ích khách hàng lên
              hàng đầu.
            </p>
          </div>
        </div>
      ...
      <div className="partners-section">
        <div className="partners-container">
          ...
          <p className="partners-subtitle">
            Chúng tôi tự hào là đối tác chính thức của các thương hiệu hàng đầu
          </p>

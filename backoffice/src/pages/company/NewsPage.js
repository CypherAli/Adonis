...
const NewsPage = () => {
  ...
  const newsArticles = [
    {
      ...
      excerpt:
        'Nike vừa chính thức ra mắt dòng Air Max 2025 với công nghệ đệm khí Air Max hoàn toàn mới, thiết kế đột phá và màu sắc ấn tượng...',
      category: 'products',
      author: 'Nguyễn Văn A',
      date: '2026-01-15',
      image: '👟',
    ...
    },
    {
      ...
      excerpt:
        'Chương trình Black Friday lớn nhất năm với ưu đãi cực sốc, giảm giá sập sàn cho Nike, Adidas, Puma và nhiều thương hiệu nổi tiếng...',
      category: 'promotions',
      author: 'Trần Thị B',
      date: '2026-01-12',
      image: '🎁',
    ...
    },
    {
      ...
      excerpt:
        'Cùng khám phá Ultraboost 24 của Adidas với công nghệ đệm Boost cải tiến, upper Primeknit+ thoáng khí và nhiều nâng cấp đáng chú ý...',
      category: 'reviews',
      author: 'Lê Văn C',
      date: '2026-01-10',
      image: '⭐',
    ...
    },
    {
      ...
      excerpt:
        'Chia sẻ 10 mẹo hay giúp bạn bảo quản giày sneaker, giữ form đẹp, màu sắc tươi mới và kéo dài tuổi thọ sản phẩm...',
      category: 'tips',
      author: 'Phạm Thị D',
      date: '2026-01-08',
      image: '💡',
    ...
    },
    {
      ...
      excerpt:
        'Shoe Store tham gia Sneaker Fest 2026 với không gian triển lãm hoành tráng, giới thiệu hơn 500 mẫu giày từ các thương hiệu nổi tiếng...',
      category: 'events',
      author: 'Hoàng Văn E',
      date: '2026-01-05',
      image: '🎉',
    ...
    },
    {
      ...
      excerpt:
        'Old Skool - mẫu giày kinh điển của Vans với thiết kế sọc đặc trưng, chất liệu canvas bền bỉ và phong cách streetwear không bao giờ lỗi mốt...',
      category: 'products',
      author: 'Nguyễn Văn A',
      date: '2026-01-03',
      image: '👟',
  ...
  return (
    <div className="news-page">
      {/* Hero */}
      <motion.section className="news-hero" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              {filteredNews.map((article, index) => (
                ...
                >
                  <div className="news-card-image">
                    <div className="news-image-placeholder">{article.image}</div>
                    <span className="news-category-badge">{getCategoryName(article.category)}</span>
                  </div>

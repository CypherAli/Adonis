    ...
    <div className="order-history-tab">
      ...
      {filteredOrders.length === 0 ? (
        <div className="no-orders">
          ...
          <button className="btn-shop-now" onClick={() => router.push('/')}>
            Mua sắm ngay
          </button>
        </div>
      ) : (
            ...
            return (
              <div key={order._id} className="order-card">
                  ...
                  <div className="order-details">
                    ...
                    <div className="detail-row price-breakdown">
                      ...
                      {order.discount && order.discount > 0 && (
                        <span className="price-item discount">
                ...
                <div className="order-card-footer">
                  <button className="btn-view-detail" onClick={() => router.push(`/orders/${order._id}`)}>
                    Chi tiết
                  </button>

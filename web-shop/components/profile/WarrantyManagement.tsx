...
const WarrantyManagement: React.FC = () => {
  ...
  const getWarrantyStatus = (deliveredDate: string, warrantyPeriod: number) => {
    ...
    const monthsLeft = Math.floor((expiryDate.getTime() - now.getTime()) / (1000 * 60 * 60 * 24 * 30))
  ...
  const getExpiryDate = (deliveredDate: string, warrantyPeriod: number) => {
  ...
  return (
    <div className="warranty-management-tab">
      <div className="warranty-header">
        ...
        <p className="warranty-description">Track warranty status of purchased products</p>
      </div>
      ...
      <div className="warranty-tabs">
        ...
        >
          ...
          {
            warranties.filter(
              (w) => getWarrantyStatus(w.deliveredDate, w.warrantyPeriod).status === 'active'
            ).length
          }
          )
        </button>
        ...
        >
          ...
          {
            warranties.filter(
              (w) => getWarrantyStatus(w.deliveredDate, w.warrantyPeriod).status === 'expiring'
            ).length
          }
          )
        </button>
        ...
        >
          ...
          {
            warranties.filter(
              (w) => getWarrantyStatus(w.deliveredDate, w.warrantyPeriod).status === 'expired'
            ).length
          }
          )
        </button>
                ...
                <div className="warranty-card-body">
                  <div className="warranty-info">
                    ...
                    <div className="info-row highlight">
                      ...
                      <span className="info-value">{formatDate(expiryDate.toString())}</span>
                    </div>
                  </div>
                      ...
                      <div className="specs-grid">
                        ...
                        {warranty.specifications.material && (
                          <span className="spec-item">
                            Chất liệu: {warranty.specifications.material}
                          </span>
                        )}
                      </div>
                    </div>
        ...
        <div className="modal-overlay" onClick={() => setSelectedWarranty(null)}>
          <div className="warranty-detail-modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2>
                <FiShield /> Warranty Details
              </h2>
              <button className="btn-close" onClick={() => setSelectedWarranty(null)}>
                ✕
              </button>
            </div>
                ...
                <div className="product-summary">
                  {selectedWarranty.productImage && (
                    <img 
                      ...
                      alt={selectedWarranty.productName}
                      onError={(e) => {
                        const target = e.target as HTMLImageElement
                        target.src = '/images/placeholder-product.svg'
                      }}
                ...
                <div className="warranty-details-grid">
                  <div className="detail-item">
                    ...
                    <span className="value">
                      #
                      {selectedWarranty.orderNumber ||
                        selectedWarranty.orderId.slice(-8).toUpperCase()}
                    </span>
                  </div>
                  <div className="detail-item">
                  ...
                  <div className="detail-item">
                    ...
                    <span className="value">
                      {formatDate(
                        getExpiryDate(
                          selectedWarranty.deliveredDate,
                          selectedWarranty.warrantyPeriod
                        ).toString()
                      )}
                    </span>
                  </div>
            ...
            <div className="modal-footer">
              <button
                ...
                onClick={() => {
                  alert('Tính năng yêu cầu bảo hành đang được phát triển')
                }}
              >

          ...
          <section className="policy-section">
            ...
            <div className="process-steps">
              <div className="process-step">
                ...
                <h4>Liên hệ</h4>
                <p>
                  Gọi <strong>084.686.5650</strong> hoặc chat online
                </p>
              </div>
              <div className="process-step">
          ...
          <section className="policy-section">
            ...
            <div className="refund-info">
              <div className="refund-method">
                ...
                <p>
                  Hoàn về tài khoản trong <strong>3-5 ngày làm việc</strong>
                </p>
              </div>
              <div className="refund-method">
                <h4>Thanh toán COD</h4>
                <p>
                  Chuyển khoản trong <strong>1-2 ngày làm việc</strong>
                </p>
              </div>
            </div>
          </section>

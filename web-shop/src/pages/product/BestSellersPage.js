    ...
    <div className="bestsellers-page">
      ...
      <div className="bestsellers-hero">
        <div className="bestsellers-hero-content">
          ...
          <p className="bestsellers-subtitle">Trusted by thousands of customers</p>
                  ...
                  <div className="product-info">
                    ...
                    <div className="product-specs">
                      <span className="spec-item">
                        � {product.variants?.[0]?.size || product.size || 'Nhiều size'}
                      </span>
                      <span className="spec-item">
                        🎨 {product.variants?.[0]?.color || product.color || 'Nhiều màu'}
                      </span>
                    </div>
                    ...
                    {product.stock && product.stock < 10 && (
                      <div className="stock-warning">⚠️ Chỉ còn {product.stock} sản phẩm</div>
                    )}
                  </div>
                </div>
              )

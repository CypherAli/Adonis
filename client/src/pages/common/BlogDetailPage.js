...
const BlogDetailPage = () => {
  ...
  const allArticles = [
    // From NewsPage
    {
      ...
      excerpt:
        'Dell vừa chính thức giới thiệu dòng laptop XPS 15 thế hệ mới với chip Intel Core Ultra mạnh mẽ, màn hình OLED 4K tuyệt đẹp...',
    ...
    },
    {
      ...
      excerpt:
        'Chương trình Black Friday lớn nhất năm với ưu đãi cực sốc, giảm giá sập sàn cho hơn 5000 sản phẩm laptop...',
      category: 'Khuyến mãi',
      author: 'Trần Thị B',
      date: '2025-11-08',
      image: '🎁',
    ...
    },
    {
      ...
      excerpt:
        'Cùng khám phá MacBook Pro M4 mới nhất của Apple với chip M4 cực mạnh, màn hình Mini-LED và nhiều nâng cấp đáng chú ý...',
      category: 'Đánh giá',
      author: 'Lê Văn C',
      date: '2025-11-05',
      image: '⭐',
    ...
    },
    {
      ...
      excerpt:
        'Chia sẻ 10 mẹo hay giúp bạn tối ưu hóa laptop, tăng hiệu suất làm việc và kéo dài tuổi thọ pin...',
      category: 'Mẹo hay',
      author: 'Phạm Thị D',
      date: '2025-11-03',
      image: '💡',
    ...
    },
    {
      ...
      excerpt:
        'Laptop Store tham gia Tech Expo 2025 với không gian triển lãm hoành tráng, giới thiệu hơn 500 mẫu laptop mới nhất...',
      category: 'Sự kiện',
      author: 'Hoàng Văn E',
      date: '2025-11-01',
      image: '🎉',
    ...
    },
    {
      ...
      excerpt:
        'ThinkPad X1 Carbon thế hệ 12 với thiết kế siêu mỏng nhẹ, bàn phím tuyệt vời và hiệu năng ổn định...',
      category: 'Sản phẩm mới',
      author: 'Nguyễn Văn A',
      date: '2025-10-28',
      image: '💻',
  ...
  return (
    <div className="blog-detail-page">
      ...
      {/* Article Header */}
      <motion.section className="article-header" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        <div className="container">
              ...
              {relatedArticles.map((relArticle, index) => (
                ...
                >
                  <div className="related-article-image">
                    <div className="related-image-placeholder">{relArticle.image}</div>
                  </div>

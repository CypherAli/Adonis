...
const CartPage = () => {
  ...
  // Redirect admin to home page - Admin không cần cart
  useEffect(() => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="item-image">
                        <img src={item.imageUrl || PLACEHOLDER_IMAGES.cart} alt={item.name} />
                        {item.stock <= 5 && (
            ...
            <div className="summary-details">
              ...
              {getSelectedTotal() < 15000000 && getSelectedTotal() > 0 && (
                <div className="shipping-notice">
                  Add {(15000000 - getSelectedTotal()).toLocaleString('vi-VN')} đ more for free
                  shipping
                </div>
              )}

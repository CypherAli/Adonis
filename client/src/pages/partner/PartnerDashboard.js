      ...
      {user?.role === 'admin' && (
        <div className="alert alert-info admin-banner">
          ...
          <div>
            ...
            <p>
              Đây là Partner Dashboard (xem thống kê partner). Để QUẢN LÝ TOÀN HỆ THỐNG (users,
              orders, products, reviews), vui lòng truy cập:
            </p>
            ...
            >
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <span style={{ fontSize: '13px', color: '#6b7280' }}>
                    {stats.activeProducts || 0} đang hoạt động
                  </span>
                </div>
              </div>
            </div>
        ...
        {activeTab === 'revenue' && (
          <>
            ...
            <div className="section-card">
              <h2>
                <FiBarChart2 /> Doanh thu 6 tháng gần đây
              </h2>
            ...
            <div className="section-card">
              <h2>
                <FiPieChart /> Doanh thu theo thương hiệu
              </h2>

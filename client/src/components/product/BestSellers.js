    ...
    try {
      ...
      const productsWithDefaults = (res.data.products || res.data).map((p) => {
        ...
        return {
          ...
          description:
            p.description ||
            'Authentic shoes, nationwide warranty. Contact hotline 084.686.5650 for more details.',
          features:
          ...
          {bestSellers.map((product, index) => (
            <div key={product._id} className="bestseller-card-wrapper">
              <div className="bestseller-card">
                ...
                <Link to={`/product/${product._id}`} className="bestseller-image-link">
                ...
                <div className="bestseller-info">
                  ...
                  <div className="bestseller-stats">
                    <span>⭐ 4.8</span>
                    <span>
                      📦 Đã bán {product.soldCount || Math.floor(Math.random() * 500) + 100}
                    </span>
                  </div>
